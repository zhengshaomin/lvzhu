...
public class Order_Processed extends Fragment {
        ...
        bmobQuery.findObjects(new FindListener<Order>() {
            ...
            public void done(List<Order> object, BmobException e) {
                ...
                if (e == null) {
                    ...
                    order_processed_listview.setAdapter(new Order_Processed.ItemListAdapter());
    ...
    class ItemListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            final Order_Processed.ItemListAdapter.ViewHolder viewHolder;
            if (convertView == null) {
                viewHolder =new Order_Processed.ItemListAdapter.ViewHolder();
                ...
                viewHolder = (Order_Processed.ItemListAdapter.ViewHolder)convertView.getTag();
            }
            ...
            Glide.with(getActivity()).load(order.getStore().getIcon().getUrl()).crossFade(800).transform(new GlideActivity(getActivity())).into(viewHolder.store_icon);
            ...
            viewHolder.linearLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("string_order_state","待处理");
        ...
        {
            public TextView good_name,goods_infomation,goods_price,store_name,delete_order,after_sales,state,time;
