...
public class Store_Order_Completed extends Fragment {
        ...
        bmobQuery.findObjects(new FindListener<Order>() {
            ...
            public void done(List<Order> object, BmobException e) {
                ...
                if (e == null) {
                    ...
                    order_completed_listview.setAdapter(new Store_Order_Completed.ItemListAdapter());
    ...
    class ItemListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            final Store_Order_Completed.ItemListAdapter.ViewHolder viewHolder;
            if (convertView == null) {
                viewHolder = new Store_Order_Completed.ItemListAdapter.ViewHolder();
                ...
                viewHolder = (Store_Order_Completed.ItemListAdapter.ViewHolder) convertView.getTag();
            }
