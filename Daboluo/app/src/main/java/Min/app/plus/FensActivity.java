...
import Min.app.plus.adapter.FansAdapter;
...
public class FensActivity extends AppCompatActivity {
        ...
        private String goods_id,ship_author_id,title,userid;
    ...
    private void initView() {
        ...
        layoutManager = new LinearLayoutManager(FensActivity.this);
    ...
    private void loadData(){
        ...
        adapter = new FansAdapter(ships = getData());
    ...
    private List<Urelation> getData() {
        ...
        public void gettrade(){
            ...
            bmobQuery.addWhereEqualTo("object",userid);//查询用户发布的贴子
            ...
            bmobQuery.findObjects(new FindListener<Urelation>() {
                ...
                public void done(List<Urelation> object, BmobException e) {
                    if (e == null) {
                        ships.clear();
                        //value.setText(object.size()+"位用户关注");
                        ...
                        Toasty.error(FensActivity.this, "刷新失败！", Toast.LENGTH_SHORT,true).show();
                    }
