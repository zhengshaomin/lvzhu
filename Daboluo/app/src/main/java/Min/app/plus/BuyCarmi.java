...
public class BuyCarmi extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buycarmi);

        toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("川旅VPN");
...
//        });
        ...
        apply_smart.setOnRefreshListener(refreshlayout -> {
            ...
            webview.loadUrl("https://222.209.200.212:4433/portal/#!/login");
