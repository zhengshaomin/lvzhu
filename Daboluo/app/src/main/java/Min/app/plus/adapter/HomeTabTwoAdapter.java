...
/**
 * 作者：daboluo on 2023/9/21 23:52
 * Email:daboluo719@gmail.com
 */
public class HomeTabTwoAdapter extends RecyclerView.Adapter<HomeTabTwoAdapter.ViewHolder>{

    private Context context;
    private List<Posts> list;
    public HomeTabTwoAdapter(List<Posts> list){
        this.list = list;
    }
    static class ViewHolder extends RecyclerView.ViewHolder{

        TextView username,content,likevalue;
    ...
    @NonNull
    @Override
    public HomeTabTwoAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cspost, parent, false);
        context = parent.getContext();
        return new HomeTabTwoAdapter.ViewHolder(view);
//---------------------
...
//----------------------
    ...
    @Override
    public void onBindViewHolder(@NonNull HomeTabTwoAdapter.ViewHolder holder, int position) {
        ...
        // 添加自定义ClickableSpan，以处理不确定的链接点击事件
